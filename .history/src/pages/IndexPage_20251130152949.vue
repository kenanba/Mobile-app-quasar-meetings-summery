...
export default defineComponent({
  ...
  setup() {
    ...
    // Speech Recognition Instance - Typ 'any' um TS Fehler zu vermeiden, da Web Speech API experimentell ist
    ...
    onMounted(() => {
      ...
      // Cast window to any to access experimentell Speech APIs
...
Transkript: "${transcript.value}"
      ...
      try {
        ...
        // TypeScript Error Handling: error is unknown
